...
void createMap2(COORD charLocation, bool blind, int range, player &user, Console &g_Console)
{
...
void createMap4(COORD charLocation, bool blind, int range, player &user, Console &g_Console)
{
	MapRender = load_map("stage4.txt");
    //render the game
